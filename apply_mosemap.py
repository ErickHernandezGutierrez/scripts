...
print('[INFO] Loading mosemap image...')
...
nib.save( nib.Nifti1Image(compsize_output,    affine, header), '%s/%s_MRDS_%s_DIAMOND_COMP_SIZE.nii'      % (MRDS_RESULTS_PATH,MRDS_PREFIX,MRDS_METHOD) )
nib.save( nib.Nifti1Image(eigenvalues_output, affine, header), '%s/%s_MRDS_%s_DIAMOND_EIGENVALUES.nii'    % (MRDS_RESULTS_PATH,MRDS_PREFIX,MRDS_METHOD) )
